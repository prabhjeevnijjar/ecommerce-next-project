...
const Newsletter = () => {
  return (
    <div className="flex mt-12 items-center align-center bg-neutralLight2">
      <img src={leftImg.src} className="w-0 md:w-1/4" alt="book shelf"></img>
      <div className="w-full md:w-1/2 py-12 md:py-0 px-auto flex flex-col items-center">
        <div className="font-poppins text-[2.5rem] text-nowrap">
          Join our Newsletter
        </div>
        <div className="font-inter text-[1.12]">
          Sign up for deals, new products and promotions
        </div>
        <div className="flex border-b-2 mt-8 py-2">
          <img src={emailIc.src} className="email" />
          <input
            type="email"
