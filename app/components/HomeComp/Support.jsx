  ...
  return (
    <div className="px-[2rem] md:px-[6rem] 2xl:px-[25rem] mt-8 flex justify-around gap-4 flex-wrap">
      <div className="min-w-[9.5rem] w-[15rem] bg-neutralLight2 px-[2rem] py-[3rem]">
        <img src={truckIc.src} alt="truck ic"></img>
        <h4 className="font-poppins text-[1.25rem] font-neutral1 mt-3">
          Free Shipping
        </h4>
        <h5 className="mt-2 font-neutralDark font-poppins text-[0.75rem] font-normal">
          Order above $200
        </h5>
      </div>
      <div className="min-w-[9.5rem] w-[15rem] bg-neutralLight2 px-[2rem] py-[3rem]">
        <img src={moneyIc.src} alt="money ic"></img>
        <h4 className="font-poppins text-[1.25rem] font-neutral1 mt-3">
          Money-back
        </h4>
        <h5 className="mt-2 font-neutralDark font-poppins text-[0.75rem] font-normal">
      ...
      <div className="min-w-[9.5rem] w-[15rem] bg-neutralLight2 px-[2rem] py-[3rem]">
        <img src={lockIc.src} alt="lock ic"></img>
        <h4 className="font-poppins text-[1.25rem] font-neutral1 mt-3">
          Secure Payments
        </h4>
        <h5 className="mt-2 font-neutralDark font-poppins text-[0.75rem] font-normal">
      ...
      <div className="min-w-[9.5rem] w-[15rem] bg-neutralLight2 px-[2rem] py-[3rem]">
        <img src={callIc.src} alt="call ic"></img>
        <h4 className="font-poppins text-[1.25rem] font-neutral1 mt-3">
          24/7 Support
        </h4>
        <h5 className="mt-2 font-neutralDark font-poppins text-[0.75rem] font-normal">
