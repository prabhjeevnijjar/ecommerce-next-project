    ...
    <div className="flex flex-col sm:flex-row px-[2rem] md:px-[6rem] 2xl:px-[25rem] align-center gap-4 mt-8">
      <div className="flex flex-col relative">
        <div className="flex flex-col absolute top-10 left-10">
          ...
          <Link
              href={`/products?category=sofa`} className="flex hover:border-solid items-center hover:border-black hover:border-b-2 cursor-pointer">
            Shop Now
            <svg
              width="20"
              height="20"
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-row relative">
          <div className="flex flex-col absolute left-10 bottom-10">
            ...
            <Link
              href={`/products?category=bedroom`} className="flex hover:border-solid items-center hover:border-black hover:border-b-2 cursor-pointer">
              Shop Now
              <svg
                width="20"
                height="20"
        ...
        <div className="flex flex-row relative">
          <div className="flex flex-col absolute left-10 bottom-10">
            ...
            <Link
              ...
              className="flex hover:border-solid items-center hover:border-black hover:border-b-2 cursor-pointer"
            >
              Shop Now
              <svg
                width="20"
